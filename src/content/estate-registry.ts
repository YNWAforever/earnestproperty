...
export const estateRegistry: EstateRegistryEntry[] = [
  ...
  },
  {
    ...
    corridorSegment: null,
    hasPage: true,
    photo: "/estates/seong-yuen.jpg",
    photoCredit: "Prosperity Horizons / Wikimedia Commons, CC BY-SA 4.0",
    homepageDistrict: "青山公路",
    parentEstateSlug: null,
